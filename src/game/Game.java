...
//                }
                player2 = new players.GreedyPlayer(2);
...
//           player 1 plays
            ...
            if (moveList.size() > 0) {
                try {
                    ...
                    validate = game.validate_movement(othelloBoard.getBoard(), boardPlace, player);
                } catch (Exception e) {
                    validate = -2;
...
//           player 2
            ...
            if (moveList.size() > 0) {
                try {
                    ...
                    validate = game.validate_movement(othelloBoard.getBoard(), boardPlace, player2);
                } catch (Exception e) {
                    validate = -2;
                    winner = player.getClass().toString();
                }
