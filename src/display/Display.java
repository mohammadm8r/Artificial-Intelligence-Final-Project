    ...
    public void updateDisplay(int[][] board, BoardSquare boardPlace, AbstractPlayer player) {
        ...
        gameRecordCounter++;
            try {
                ...
                buttonsGameRecord[boardPlace.getRow()][boardPlace.getCol()].getButton().setFont(new Font("Lucida Grande", 1, 18)); // NOI18N
    ...
    private void setRecordGameTab() {
        ...
        for (int i = 0; i < gameRecord.length; i++) {
            for (int j = 0; j < gameRecord[i].length; j++) {
                ...
                buttonsGameRecord[i][j].getButton().setFont(new Font("Lucida Grande", 1, 18));
